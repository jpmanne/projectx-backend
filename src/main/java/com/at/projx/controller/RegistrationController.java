...
public class RegistrationController extends BaseController {
	...
	public ResponseEntity<Response> basicSetup(@Valid @RequestBody BasicSetupRequest basicSetupRequest) {
		...
		try {
			...
			organizationDetails.setOrganizationCode(UniversalUniqueCodeGenerator.getInstance().getUniqueCode());
			...
			if(organizationDetails.getOrganizationDetailsId() != null) {
				...
				password = UniversalUniqueCodeGenerator.getInstance().getAutoGeneratedPassword();
